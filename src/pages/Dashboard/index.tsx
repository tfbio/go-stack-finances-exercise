...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    api.get<ApiResponse>('/transactions').then(response => {
      const apiTransaction = response.data.transactions;
      ...
      const formattedTransaction: Transaction[] = apiTransaction.map(
        transaction => ({
          ...transaction,
